/*
Name: 이형주(Lee HyungJu)
# of Assignment: 1
Name of file: decomment.c
*/
#include <stdio.h>
#include <assert.h>
#include <stdlib.h>
...
Error: Prints error if Input.c file has unterminated comment
Return: EXIT_SUCCESS if terminated succesfully, EXIT_FAILURE if un terminated comment
*/
int main(void)
{
